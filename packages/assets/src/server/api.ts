...
export type get__bundle = typeof get__bundle;
export const get__bundle = {
  method: z.literal("GET"),
  path: z.literal("/bundle"),
  requestFormat: z.literal("json"),
  parameters: z.never(),
  response: z.unknown(),
};

export type post__bundle = typeof post__bundle;
export const post__bundle = {
